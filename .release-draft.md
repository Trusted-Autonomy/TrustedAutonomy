...
## Full release notes — v0.15.30-alpha.2 milestone
...
- **Fixed Windows startup crash** — delay-load `ProjectedFSLib.dll` so `ta` starts on
  Windows machines without Client-ProjFS installed (v0.15.30.2.1)
